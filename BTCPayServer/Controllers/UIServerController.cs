...
namespace BTCPayServer.Controllers
{
    ...
    public partial class UIServerController : Controller
    {
        ...
        public async Task<IActionResult> DeleteDynamicDnsService(string hostname)
        {
            ...
            return View("Confirm",
                new ConfirmModel("Delete dynamic DNS service",
                    $"Deleting the dynamic DNS service for <strong>{Html.Encode(hostname)}</strong> means your GRSPay Server will stop updating the associated DNS record periodically.", "Delete"));
        }
        ...
        {
            return View("Confirm", new ConfirmModel("Disable modification of SSH settings", "This action is permanent and will remove the ability to change the SSH settings via the GRSPay Server user interface.", "Disable"));
        }
