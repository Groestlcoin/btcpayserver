...
"""
{
  ...
  "A self-hosted, open-source groestlcoin payment processor.": "",
  "Abort": "",
  ...
  "Address verified.": "",
  "Addresses": "",
  "Adjust the design of your GRSPay Server instance to your needs.": "",
  ...
  "Any uploaded files are being saved on the same machine that hosts GRSPay; please pay attention to your storage space.": "",
  "API": "",
  ...
  "Browser connection": "",
  "Browser Redirect": "",
  "GRSPay exposes Core Lightning's REST service for outside consumption, you will find connection information here.": "",
  "GRSPay is expecting you to access this website from <strong>": "",
  "GRSPay Server Configurator": "",
  "GRSPay Server currently supports:": "",
  "GRSPay Server Registration will redirect to a custom registration page": "",
  "GRSPay Server Supporters": "",
  "GRSPay will restart momentarily.": "",
  "Bump fee": "",
  ...
  "Card reset succeed": "",
  "Categories": "",
  "Caution: Allowing non-admins to have access to API endpoints may expose your GRSPay Server instance to potential security risks from unknown users.": "",
  "Caution: Enabling public user registration means anyone can register to your server and may expose your GRSPay Server instance to potential security risks from unknown users.": "",
  ...
  "Changes to the SSH settings are now permanently disabled in the GRSPay Server user interface": "",
  ...
  "Checking GRSPay Server Vault is running...": "",
  ...
  "Connect GRSPay Server to your Shopify checkout experience to accept Groestlcoin.": "",
  ...
  "Dynamic": "",
  "Dynamic DNS allows you to have a stable DNS name pointing to your server, even if your IP address changes regularly. This is recommended if you are hosting GRSPay Server at home and wish to have a clearnet domain to access your server.": "",
  "Dynamic DNS Service": "",
  ...
  "Easily log into GRSPay Server on another device using a simple login code from an already authenticated device.": "",
  "Edit": "",
  "Edit dates": "",
  "Edit Field": "",
  "Edit Form": "",
  ...
  "Email rules": "",
  "Email Rules": "",
  "Email rules allow GRSPay Server to send customized emails from your server based on events.": "",
  "Email rules allow GRSPay Server to send customized emails from your store based on events.": "",
  ...
  "Expires in": "",
  "Export": "",
  "Export the PSBT for your wallet, sign it, then import the signed PSBT here. Broadcasting through GRSPay requires separate permission.": "",
  "Extended public key": "",
  ...
  "Generate a new api key to use GRSPay through its API.": "",
  ...
  "Generated Code": "",
  "Get Link": "",
  "Give other registered GRSPay Server users access to your store. See the {0} for granted permissions.": "",
  ...
  "If GRSPay Server shows you an invalid balance, {0}.<br />If some transactions appear in GRSPay Server, but are missing in another wallet, {1}.": "",
  ...
  "If some transactions appear in GRSPay Server, but are missing in another wallet, {0}.": "",
  ...
  "In order to securely connect to your hardware wallet you must first download, install, and run the GRSPay Server Vault.": "",
  ...
  "Include Archived": "",
  "Incorrect pin code.": "",
  "Increase the security of your instance by disabling the ability to change the SSH settings in this GRSPay Server instance's user interface.": "",
  "Index": "",
  ...
  "Maintainer": "",
  "Maintenance": "",
  "Maintenance feature requires access to SSH properly configured in GRSPay Server configuration.": "",
  "Make Crowdfund Public": "",
  "Make sure this GRSPay Server instance belongs to you.": "",
  "Manage": "",
  "Manage Account": "",
  "Manage billing": "",
  "Manage labels": "",
  ...
  "Modify": "",
  "Monetization": "",
  "Monetization allows you to get paid for sharing your GRSPay Server instance with other users.": "",
  ...
  "Payout Processors": "",
  "Payout Processors allow GRSPay Server to handle payouts in an automated way.": "",
  ...
  "Plugin Updates": "",
  "Plugins": "",
  "Plugins are developed by third parties. They need to be updated and maintained regularly in addition to GRSPay Server. Use plugins at your own risk.": "",
  "Point of Sale": "",
  "Point of Sale Style": "",
  "Policies": "",
  ...
  "REST Uri": "",
  "Restart": "",
  "Restart GRSPay Server and related services.": "",
  "Restart now": "",
  "Retired": "",
  "Retiring": "",
  "Retry": "",
  ...
  "Set a schedule for automated On-Chain Groestlcoin Payouts.": "",
  "Set as default": "",
  "Set Password": "",
  ...
  "Some plugins were disabled due to fatal errors. They may be incompatible with this version of GRSPay Server.": "",
  "Sort by": "",
  ...
  "Thank you!": "",
  "The {0} offers programmatic access to your instance. You can manage your GRSPay Server (e.g. stores, invoices, users) as well as automate workflows and integrations (see {1}). For that you need the API keys, which can be generated here. Find more information in the {2}.": "",
  ...
  "The change output is too small to pay for additional fee. (Missing {0} GRS)": "",
  ...
  "The preferred link to this server. This is typically used when GRSPay Server is generating an email containing a link which should point to this server.": "",
  ...
  "There are no associated permissions to the API key being requested by the application. The application cannot do anything with your GRSPay Server account other than validating your account exists.": "",
  ...
  "This action is permanent and will remove the ability to change the SSH settings via the GRSPay Server user interface.": "",
  ...
  "This page exposes information to use the configured GRSPay Server Configurator to modify this setup.": "",
  ...
  "Translations enable you to translate the GRSPay Server backend into different languages.": "",
  "Trial": "",
  "Trial Period": "",
  "Trial Period (days)": "",
  "Trigger": "",
  ...
  "Unsupported hardware wallet, try to update GRSPay Server Vault": "",
  "Unsuspend Access": "",
  "Unused ({0})": "",
  "Unused Permissions": "",
  "Unusual": "",
  ...
  "Update Role": "",
  "Update to the latest version of GRSPay Server.": "",
  "Update Webhook": "",
  "Update your account": "",
  ...
  "Using GRSPay Server Vault": "",
  "Using GRSPay Server Vault (NFC)": "",
  "Using the GRSPay Server internal node for this store requires no further configuration. Click the save\n                    button below to start accepting Groestlcoin through the Lightning Network.": "",
  ...
  "Wallets": "",
  "Warning: No wallet has been linked to your GRSPay Server Store.": "",
  ...
  "Webhooks": "",
  "Webhooks allow GRSPay Server to send HTTP events related to your store to another server.": "",
  "Welcome to {0}": "",
  ...
  "You can also use this LNDhub-URL as the connection string and GRSPay Server converts it into the expected\n                                <code>type=lndhub</code> connection string format:": "",
  ...
  "You need to restart GRSPay Server in order to update your active plugins.": "",
  ...
  "Your access to GRSPay Server is over an unsecured network. If you are using the docker deployment method with NGINX and HTTPS is not available, you probably did not configure your DNS settings correctly. We disabled the register and login link so you don't leak your credentials.": "",
