...
var vaultui = (function () {
    ...
    */
    ...
    var VaultFeedbacks = {
        vaultLoading: new VaultFeedback("?", "Checking GRSPay Server Vault is running...", "vault-loading"),
        ...
        noVault: new VaultFeedback("failed", "GRSPay Server Vault does not seem to be running, you can download it on <a target=\"_blank\" href=\"https://github.com/Groestlcoin/GRSPayServer.Vault/releases/latest\">Github</a>.", "no-vault"),
        ...
        bridgeConnected: new VaultFeedback("ok", "GRSPayServer successfully connected to the vault.", "bridge-connected"),
        vaultNeedUpdate: new VaultFeedback("failed", "Your GRSPay Server Vault version is outdated. Please <a target=\"_blank\" href=\"https://github.com/Groestlcoin/GRSPayServer.Vault/releases/latest\">download</a> the latest version.", "vault-outdated"),
