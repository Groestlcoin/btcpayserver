...
var vaultui = (function () {
    ...
    */
    ...
    var VaultFeedbacks = {
        vaultLoading: new VaultFeedback("?", "Checking GRSPayServer Vault is running...", "vault-feedback1", "vault-loading"),
        ...
        noVault: new VaultFeedback("failed", "GRSPayServer Vault does not seem to be running, you can download it on <a target=\"_blank\" href=\"https://github.com/Groestlcoin/GRSPayServer.Vault/releases/latest\">Github</a>.", "vault-feedback1", "no-vault"),
