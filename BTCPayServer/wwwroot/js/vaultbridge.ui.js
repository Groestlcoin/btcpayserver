...
var vaultui = (function () {
    ...
    */
    ...
    var VaultFeedbacks = {
        vaultLoading: new VaultFeedback("?", "Checking GRSPay Server Vault is running...", "vault-feedback1", "vault-loading"),
        ...
        noVault: new VaultFeedback("failed", "GRSPay Server Vault does not seem to be running, you can download it on <a target=\"_blank\" href=\"https://github.com/Groestlcoin/GRSPayServer.Vault/releases/latest\">Github</a>.", "vault-feedback1", "no-vault"),
        ...
        bridgeConnected: new VaultFeedback("ok", "GRSPayServer successfully connected to the vault.", "vault-feedback1", "bridge-connected"),
        vaultNeedUpdate: new VaultFeedback("failed", "Your GRSPay Server Vault version is outdated. Please <a target=\"_blank\" href=\"https://github.com/Groestlcoin/GRSPayServer.Vault/releases/latest\">download</a> the latest version.", "vault-feedback2", "vault-outdated"),
