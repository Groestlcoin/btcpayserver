...
function inputChanges(event, buttonSize) {
    ...
    html += srvModel.payButtonText
        ? `<button type="submit" class="submit" name="submit" style="min-width:${width};min-height:${height};border-radius:4px;border-style:none;background-color:#0f3b21;" title="Pay with GRSPay Server, a Self-Hosted Groestlcoin Payment Processor"><span style="color:#fff">${esc(srvModel.payButtonText)}</span>\n` +
