...
namespace BTCPayServer.Services
{
    public static class EmailSenderExtensions
    {
        ...
        public static void SendSetPasswordConfirmation(this IEmailSender emailSender, string email, string link, bool newPassword)
        {
            ...
            var body = $"A request has been made to {(newPassword ? "set" : "update")} your GRSPay Server password. Please confirm your password by clicking below. <br/><br/> {CallToAction(subject, HtmlEncoder.Default.Encode(link))}";
