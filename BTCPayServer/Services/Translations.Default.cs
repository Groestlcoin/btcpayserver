...
"""
{
  ...
  "Download PSBT file": "",
  "Dynamic": "",
  "Dynamic DNS allows you to have a stable DNS name pointing to your server, even if your IP address changes regulary.\n                This is recommended if you are hosting GRSPay Server at home and wish to have a clearnet domain to access your server.": "",
  ...
  "There are no associated permissions to the API key being requested by the application.\n                The application cannot do anything with your GRSPay Server account other than validating your account exists.": "",
