...
"""
{
  ...
  "GRSPay Server Vault does not seem to be running, you can download it on {0}.": "",
  "GRSPay will restart momentarily.": "",
  "GRSPayServer successfully connected to the vault.": "",
  "Bump fee": "",
  ...
  "Using the GRSPay Server internal node for this store requires no further configuration. Click the save button below to start accepting Groestlcoin through the Lightning Network.": "",
  ...
  "You can also use this LNDhub-URL as the connection string and GRSPay Server converts it into the expected <code>type=lndhub</code> connection string format:": "",
  ...
  "You received it, the GRSPay Server SMTP settings work.": "",
